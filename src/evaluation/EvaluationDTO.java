...
public class EvaluationDTO {
	...
	String totalScore;
	String indegreeScore;
	String lectureScore;
	String gradeScore;
	int likeCount;
	public String getIndegreeScore() {
		return indegreeScore;
	}
	public void setIndegreeScore(String indegreeScore) {
		this.indegreeScore = indegreeScore;
	}
	...
	public EvaluationDTO(int evaluationID, String userID, String lectureName, String professorName, int lectureYear,
			...
			String totalScore, String lectureScore,String indegreeScore, String gradeScore, int likeCount) {
		super();
		this.evaluationID = evaluationID;
		this.userID = userID;
		this.lectureName = lectureName;
